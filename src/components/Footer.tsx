...
const Footer: React.FC = () => {
  return (
    <footer className="bg-gray-100 border-t border-gray-200 mt-auto py-4">
      <div className="container mx-auto px-4 text-center text-sm text-gray-600 max-w-4xl">
        <p className="mb-2">
          © {new Date().getFullYear()} Christopher Oeser - Newcastle University
        </p>
        <p className="text-xs">
            ...
            Built with React, TypeScript, TensorFlow.js, and Tailwind CSS.
            </p>
